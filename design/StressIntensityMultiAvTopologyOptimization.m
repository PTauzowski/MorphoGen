classdef StressIntensityMultiAvTopologyOptimization < StressIntensityTopologyOptimizationVol
    %UNTITLED Summary of this class goes here
    %   Detailed explanation goes here
    
    properties
        FEAnalyses, plLambda, plVol, plMaxStress, lastStableFrame, alphas;
    end
    
    methods
        function obj = StressIntensityMultiAvTopologyOptimization(Rmin,FEAnalyses,alphas,maxais,penal,volFr,is_const)
...
%            fprintf('lambda=%5.3g ', obj.FEAnalysis.lambda);
        ...
        function ais = computeAverageIntensities(obj)
            ...
            ais = mean(hm_stress,2)/ max(hm_stress,[],"all");
        end
