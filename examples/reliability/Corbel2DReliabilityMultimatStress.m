...
randomVariables={RandomVariable("Normal",E1,0.1*E1) RandomVariable("Normal",E2,0.1*E2) RandomVariable("Normal",E3,0.1*E3),RandomVariable("Normal",P1,0.1*abs(P1)) RandomVariable("Normal",P2,0.1*abs(P2))};
...
% mpps = tuner.checkModality(0.5)
 ...
 % tuner.plotMC3D(1,2,["E1" "E2" "E3" "Px" "Py"],'u');
 % tuner.plotMC3D(2,3,["E1" "E2" "E3" "Px" "Py"],'u');
 % tuner.plotMC3D(1,3,["E1" "E2" "E3" "Px" "Py"],'u');
