...
randomVariables={RandomVariable("Normal",P(1),2) RandomVariable("Normal",P(2),0.1) RandomVariable("Normal",P(3),1)};
transform=IndependentTransformation(randomVariables);
g=loadSolidFatiguePerformanceFunction(model,fatigueData);
...
%tuner.tuneFORM();
 ...
 sora2 = SORA('LShapeFatigueBeta2', model,topOpt, randomVariables, g, transform, 2);
 sora3 = SORA('LShapeFatigueBeta3', model,topOpt, randomVariables, g, transform, 3);
 %sora.checkTuning();
