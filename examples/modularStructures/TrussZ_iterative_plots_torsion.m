...
basename='TrussZ_iterative_plots';
...
topOpt = StressIntensityTopologyOptimizationVol2( Rfilter, analysis, cutTreshold, penal, 0.45, false );
topOpt.setConstElems(const_elems);
topOpt.cnodes=topOpt.FEAnalysis.mesh.elems( const_elems, : );
...
y2 = smoothdata(y2, 'movmean', smooth_factor);
...
% ylim([-120, 120]); % For the right axis
