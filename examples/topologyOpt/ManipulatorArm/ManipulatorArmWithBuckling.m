...
analysis.elementLoadSurfaceIntegral( "global", loadedFaceSelector, ["ux" "uy" "uz"], @(x)( x*0 + [0 0 -1.0E7] ));
...
analysisSecondOrder = SecondOrderElasticityWeighted( fe, mesh, 0.00, false );
