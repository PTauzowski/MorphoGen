...
analysisLinear = LinearElasticityWeighted( fe, mesh, true );
...
analysisLinear.loadClosestNode([aspect*l/2, l ], ["ux" "uy"], [0 -P] );
...
figure;
tic
topOptBuckling = StressIntensityTopologyOptimizationBuckling( Rfilter, analysisWithBuckling, cutTreshold, penal, 0.15, true );
[objF, xopt]  = topOptBuckling.solve();
toc


% tic
% topOpt = StressIntensityTopologyOptimizationVol( Rfilter, analysisLinear, cutTreshold, penal, 0.1, true );
% [objF, xopt]  = topOpt.solve();
% toc
% 
% figure;
% tic
% topOpt = SIMP_MMA_TopologyOptimizationElasticCompliance(Rfilter, analysisLinear, penal, 0.1, true);
% [objF, xopt]  = topOpt.solve();
% toc
% 
