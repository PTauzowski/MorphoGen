function [vN, vTy, vTz, vMs, vMy, vMz, all_forces] = computeAllInternalForces(frameNodes,frameElems,E,nu,betas)
    mesh=Mesh();
    mesh.nodes=frameNodes(:,:,1);
    frameElem=Frame3D(frameElems,E,0.02,0.8*E,0.0004,0.0004,0.1*E);
