function  developResultsForTopology(filename,title,model,R,r, alpha, res,segmentLength,segmentNo,xOpt,betas,dispFactor,Rfilter,cutTreshold,penal)
    ...
    plotArmConfigurationHMextended(title,filename+".pdf",model.fe.mat.E,model.fe.mat.nu,segmentLength,R,r,res, model.halfSegmentNelems, segmentNo, alpha, betas, model.fe.shapeFn, xOpt, dispFactor);
