function  [maxHM_dd, maxDisp_dd, maxHM_top, maxDisp_top] = prepareResults(filename, title, model,R,r, alpha, res, res_th, segmentLength,max_segments,xOpt,topOpt,betas,dispFactor,Rfilter,cutTreshold,penal,Pz)
    ...
    [maxHM_dd, maxDisp_dd, maxHM_top, maxDisp_top] = ArmStressAndDispArm(model.fe.mat.E,model.fe.mat.nu,segmentLength,R,r,res, res_th, alpha, betas, model.fe.sf, xOpt, Pz );
