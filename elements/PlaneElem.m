    ...
    methods
        ...
        function plotWithSettings(obj, nodes, varargin)
            ...
            if exist('C','var')
                colormap('jet');
                colorbar;
                patch('Vertices', nodesplot, 'Faces', obj.elems(elem_num,obj.shapeFn.contour), 'FaceVertexCData', C , "FaceColor", "interp", "EdgeColor","none", "FaceAlpha", 1 );
            else 
                patch('Vertices', nodesplot, 'Faces', obj.elems(elem_num,obj.shapeFn.contour),'FaceColor',elem_color,'EdgeColor',edge_color,'LineWidth',0.01);
            end
            if plotNodes
